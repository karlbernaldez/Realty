            ...
            <div className="flex flex-col mb-[38px] gap-[23px]">
              ...
              <div className="flex flex-col gap-[22px]">
                ...
                <div className="flex flex-col items-center gap-4">
                  ...
                  <button type="submit" className="w-full h-12 px-40 py-3.5 bg-green-800 rounded justify-center items-center gap-2.5 inline-flex">
                    <Link to="/dashboard" className="text-white text-base font-bold font-['Helvetica']" style={{ color: '#FFFFFF' }}>
                      Log in
                    </Link>
                  </button>
